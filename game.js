 ...
 *
 * Applied edits:
 *   - removed DeKhan block (71 lines)
 *   - unwrapped draw = DeKhan.loopDetect(...)
 *   - removed PJSCodeInjector.hasOrHadDrawLoop assignment
 */
...
/* DeKhan block removed by tools/convert.js — Khan Academy loop-guard stripping is not applicable outside KA. */
...
draw = (function() {
    try{
      //  println(poofs.length);
        ...
        //Reduces lag - Vexcess
        /* PJSCodeInjector poke removed by tools/convert.js */
